    ...
    if (item.status === 'COMPLETE') {
      ...
      if (fs.existsSync(`M:/Reportes/${item.id}.html`)) {
        ...
        this.afs.doc(`Plantillas/${ruta}`).valueChanges().pipe(switchMap((m: any) => {
          ...
          html += "<tr><td align = 'center'>" + Date.now() + "</td><td align = 'center'>" + item.proyecto.nombre + "</td>  <td class='barcode' align='center'>*" + "departamento" + "*</td> <td align = 'center'>" + item.document + "</td> <td align = 'center'>" + item.pathname + "</td> <td align = 'center'>" + item.contador + "</td><td align = 'center'>" + item.contador + "</td> </tr></table><br/>";
